...
public class LangScriptEngine {
     ...
     * @return
     */
    public String createCode(PackageConfig packageConfig, ClassConfig config, Properties props, String template) {
        ...
        template = template.replace(Macro.$BUFFER, "buffer").replace(Macro.$CONFIG, "config")
                ...
                .replace(Macro.$PACK_NAME, packageConfig.packName != null ? packageConfig.packName : "");
